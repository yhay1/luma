...
type Post = {
  ...
  content: string
  created_at: string
  author: { username: string; display_name: string; avatar_path?: string | null; avatar_visible?: boolean }
  likes: number
  liked: boolean
  replies: Reply[]
}
