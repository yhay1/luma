    ...
    <div className="min-h-screen bg-background text-foreground pb-20 md:pb-0">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-5 md:grid-cols-[210px_minmax(0,680px)_240px] md:gap-10 md:px-8 md:py-8">
        ...
        <main className="flex flex-col gap-5">
          {statusRail}
          <div className="border-b border-border/60 pb-5"><p className="font-mono text-[11px] uppercase tracking-[0.18em] text-primary">Your private orbit</p><h1 className="mt-2 font-serif text-4xl tracking-tight md:text-5xl">Your circle</h1><p className="mt-2 max-w-md text-sm leading-6 text-muted-foreground">A quiet place for the people you keep close. Share a thought, see what matters.</p></div>
